...
def main():
    ...
    if "bibtex-export" == "ris-export":
    ...
    elif "bibtex-export" == "bibtex-export":
        ...
        if not params.get("dry_run", True) and params.get("source_mode") == "live_archived":
            write_json(raw_dir() / "bibtex-export_request.json", payload)
    write_json(os.environ["RWB_OUTPUT_bibtex"], payload)
