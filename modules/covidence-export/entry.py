...
def main():
    ...
    if "covidence-export" == "ris-export":
        lines = []
    ...
    elif "covidence-export" == "bibtex-export":
        ...
        if not params.get("dry_run", True) and params.get("source_mode") == "live_archived":
            write_json(raw_dir() / "covidence-export_request.json", payload)
    write_json(os.environ["RWB_OUTPUT_covidence_package"], payload)
